...
> **Dataset Filename**: [`cchain_cdo_dengue_surveillance_ready.csv`](../data/processed/cchain_cdo_dengue_surveillance_ready.csv)  
...
> **Class Balance (`is_outbreak`)**: Normal (`0`): 17,922 (94.93%), Outbreak (`1`): 958 (5.07%)  
> **Total Surveillance Records**: 80 Barangays over 20 Years  
...
graph TD
    ...
    subgraph S2["Spatial & Biological Engineering Pipeline"]
        ...
        THRESH["Epidemiological Baseline Calculation<br/>(Pre-2019 Training 75th Percentile Baseline)"]
    end
...
### Category A: Spatial Geometry & Identifiers (9 Features)
...
### Category B: Ambient Meteorology at Month T (9 Features)
...
### Category F: Urban-Climate Physical Interactions (5 Features)
...
* `brgy_p75_threshold` (Pre-2019 training 75th percentile historical baseline, minimum 5 cases)
...
* **Top Performance**: **0.8148 PR-AUC**, **0.9637 ROC-AUC**, **91.74% Recall** at F2-optimal threshold.
...
* **Top Performance**: **0.7801 PR-AUC**, **0.9564 ROC-AUC**, **91.12% Recall** at F2-optimal threshold.
